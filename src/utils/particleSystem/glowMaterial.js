...
class FakeGlowMaterial extends ShaderMaterial {
   ...
   * @param {number} [parameters.falloff=1] - The falloff factor for the glow effect.
   ...
   * @param {number} [parameters.glowSharpness=1] - The sharpness of the glow effect.
   * @param {number} [parameters.opacity=1] - The opacity of the hologram.
